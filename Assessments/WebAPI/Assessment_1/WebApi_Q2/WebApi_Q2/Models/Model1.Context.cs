...
namespace WebApi_Q2.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        [DbFunction("NorthwindEntities", "fn_getcumstomerbycountry")]
        public virtual IQueryable<fn_getcumstomerbycountry_Result> fn_getcumstomerbycountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_getcumstomerbycountry_Result>("[NorthwindEntities].[fn_getcumstomerbycountry](@country)", countryParameter);
        }
